      ...
      <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="md:flex-1 order-2 md:order-2 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 justify-center md:justify-start">
            <button
              className="px-3 py-2 md:px-5 md:py-2.5 text-sm font-medium rounded-lg transition-transform hover:scale-105 w-44 sm:w-auto mx-auto sm:mx-0"
              style={{
            ...
            <button
              ...
              className="px-3 py-2 md:px-5 md:py-2.5 text-sm font-medium rounded-lg border transition-transform hover:scale-105 w-44 sm:w-auto mx-auto sm:mx-0"
              style={{
